...
<body>
<div id="login">
<form action="main_screen" method="post">
...
<p>
{{-- <a  href="https://www.facebook.com/?_rdr=p" class="facebook-before" ><img src="fbicon.png"></a> --}}
<button type="button" class="btn btn-primary btn-lg" >Login Using Facbook</button>
</p>
